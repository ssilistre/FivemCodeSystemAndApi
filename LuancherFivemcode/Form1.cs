...
namespace LuancherFivemcode
{
    public partial class Form1 : Form
    {
        ...
        {
            rp.closeFivem();
            rp.open("https://fivemcode.com"); //Bu kod internet sitesi açmak için örnek olarak eklenmiştir.
        }
        ...
        {
            rp.open("https://panel.fivemcode.com");
        }

        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            rp.open("https://market.fivemcode.com");
        }

        private void reklam1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            rp.open("https://fivemcode.com");
        }
    }
}
